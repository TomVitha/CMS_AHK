#Hotstring EndChars `t          ; * Tab is now the only ending character - needs to be typed after the abbreviation to trigger
...
:o:address::<address></address>{left 10}
:o:area::<area>{left 0}
:o:article::<article></article>{left 10}
...
:o:details::<details></details>{left 10}
...
:o:map::<map></map>{left 6}
:o:mark::<mark></mark>{left 7}
; :o:marquee::<marquee></marquee>{left 10}
:o:menu::<menu></menu>{left 7}
:o:meta::<meta>{left 0}
; :o:meter::<meter></meter>{left 8}
:o:nav::<nav></nav>{left 6}
; Remove duplicate nav entry
; :o:nobr::<nobr></nobr>{left 7}
; :o:noembed::<noembed></noembed>{left 10}
...
:o:picture::<picture></picture>{left 10}
; :o:plaintext::<plaintext></plaintext>{left 12}
...
:o:section::<section></section>{left 10}
...
:o:sub::<sub></sub>{left 6}
:o:summary::<summary></summary>{left 10}
:o:sup::<sup></sup>{left 6}
...
:o:tfoot::<tfoot></tfoot>{left 8}
:o:th::<th></th>{left 5}
:o:thead::<thead></thead>{left 8}
:o:time::<time></time>{left 7}
:o:title::<title></title>{left 8}
:o:tr::<tr></tr>{left 5}
:o:track::<track></track>{left 8}
; :o:tt::<tt></tt>{left 5}
; :o:u::<u></u>{left 4}
:o:ul::<ul></ul>{left 5}
:o:var::<var></var>{left 6}
:o:video::<video></video>{left 8}
:o:wbr::<wbr>{left 0}
; :o:xmp::<xmp></xmp>{left 6}